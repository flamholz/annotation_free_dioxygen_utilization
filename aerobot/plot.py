...
PRETTY_NAMES = {'ko':'All gene families', 'embedding_oxygen_genes':'O$_2$ enzymes', 'chemical':'Chemical features', 'ko_terminal_oxidase_genes': 'Terminal oxidases'}
...
def plot_model_accuracy_barplot(results:Dict[str, Dict], ax:plt.Axes=None, feature_type_order:List[str]=None) -> NoReturn:
    ...
    ax.bar(np.arange(0, len(feature_types), 1) + 0.2, test_accs, width=0.4, label='testing', color=colors, edgecolor='k', linewidth=0.5)
